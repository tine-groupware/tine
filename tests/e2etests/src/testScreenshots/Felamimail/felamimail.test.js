...
describe('MainScreen', () => {
    test('Grid', async () => {
        await lib.makeScreenshot(page, {path: 'screenshots/StandardBedienhinweise/5_standardbedienhinweise_email.png'});
        await lib.makeScreenshot(page, {path: 'screenshots/EMail/2_email_posteingang_geflaggt.png'});
        await lib.makeScreenshot(
            page, {path: 'screenshots/EMail/3_email_posteingang_speicherplatz.png',
    ...
    test('choose grid fields', async () => {
        ...
        await lib.makeScreenshot(
            page, {path: 'screenshots/StandardBedienhinweise/6_standardbedienhinweise_email_spaltenauswahl.png',  //@ todo x/y of element +/-.
            clip: {x: 1000, y: 0, width: 1366 - 1000, height: 500}}
        );
        await lib.makeScreenshot(
            page, {path: 'screenshots/EMail/1_email_favoriten_und_konten.png',
...
describe('context menu', () => {
    ...
    test.skip('add mail filter', async () => {
        ...
        await lib.makeScreenshot(popup,{path: 'screenshots/EMail/13_email_filterregeln_auswahl.png'});
...
describe('filterBar', () => {
    ...
    test('delete all filter', async () => {
        ...
        await lib.makeScreenshot(
            page, {path: 'screenshots/StandardBedienhinweise/110_standardbedienhinweise_alle_filter_zuruecksetzen.png',
    ...
    test('alternate filter', async () => {
        ...
        await lib.makeScreenshot(
            page, {path: 'screenshots/StandardBedienhinweise/14_standardbedienhinweise_alternativen_filter_entfernen.png',
            clip: {x: 850, y: 0, width: 1366 - 850, height: 200}}
        );
