...
describe.skip('employee', () => {
    ...
    test('open EditDialog', async () => {
        ...
        await lib.makeScreenshot(newPage, 'screenshots/StandardBedienhinweise/16_standardbedienhinweise_hr_eingabemaske_neu.png');
        await lib.makeScreenshot(newPage, 'screenshots/HumanResources/6_humanresources_mitarbeiter_dialog.png');
    ...
    test('costcenter', async () => {
        ...
        await lib.makeScreenshot(newPage, 'screenshots/HumanResources/8_humanresources_mitarbeiter_kostenstellen.png');
    });

    test('contracts', async () => {
        await expect(newPage).toClick('.x-tab-strip-text', {text: 'Verträge'});
        await newPage.waitForTimeout(1000);
        await lib.makeScreenshot(newPage, 'screenshots/HumanResources/9_humanresources_mitarbeiter_vertraege.png');
    ...
    test('add Tag', async () => {
        ...
        await lib.makeScreenshot(newPage, 'screenshots/StandardBedienhinweise/19_standardbedienhinweise_hr_eingabemaske_neu_tag.png');
        ...
        await lib.makeScreenshot(newPage, 'screenshots/StandardBedienhinweise/20_standardbedienhinweise_hr_eingabemaske_neu_tag_auswahl.png');
    ...
    describe('edit employee', () => {
        ...
        test('vacation', async () => {
            ...
            await newPage.waitForTimeout(2000);
            await lib.makeScreenshot(newPage, 'screenshots/HumanResources/11_humanresources_mitarbeiter_vertraege.png');
...
describe.skip('employee accounts', () => {
    ...
    test('mainpage', async () => {
        ...
        await lib.makeScreenshot(newPage, 'screenshots/HumanResources/14_humanresources_personalkonten_dialog.png');
    });
