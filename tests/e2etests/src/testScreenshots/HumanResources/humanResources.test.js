...
beforeAll(async () => {
    ...
    await lib.makeScreenshot(
        page, {path: 'screenshots/HumanResources/1_humanresources_module.png',
...
describe.skip('employee', () => {
    ...
    test('add Tag', async () => {
        ...
        await lib.makeScreenshot(newPage, {path: 'screenshots/StandardBedienhinweise/19_standardbedienhinweise_hr_eingabemaske_neu_tag.png'});
