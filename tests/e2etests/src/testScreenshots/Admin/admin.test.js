...
describe('application', () => {
    ...
    test('addressbook settings', async () => {
        ...
        await lib.makeScreenshot(editDialog, {path: 'screenshots/Administration/11_admin_admin_einstellung.png'});
    ...
    test('hr settings', async () => {
        ...
        await lib.makeScreenshot(editDialog,{path: 'screenshots/Administration/17_admin_hr_einstellungen.png'});
        await editDialog.close();
    });
