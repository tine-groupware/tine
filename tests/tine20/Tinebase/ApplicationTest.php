    ...
    public function testGetModelsOfAllApplications()
    {
        ...
        $expectedData = array(
            ...
            'Calendar' => array(
                ...
                Calendar_Model_SyncContainerConfig::class,
                Calendar_Model_iMIP::class,
            ),
            'CoreData' => array(
            ...
            'Sales' => array(
                ...
                Sales_Model_Einvoice_XRechnungOverwrite::class,
                ...
                Sales_Model_PaymentMeans::class,
                ...
                Sales_Model_PurchasePaymentMeans::class,
            ...
            'Tinebase' => array(
                ...
                Tinebase_Model_BatchJobCallable::class,
