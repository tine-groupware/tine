    ...
    public function tearDown(): void
{
    ...
    */
    ...
    public function testUpdateEventWithExceptions()
    {
        $this->_testNeedsTransaction();
        $createdEvent = new Calendar_Model_Event($this->testCreateEvent(), true);
        $savedEvent = $this->_uit->saveEvent($createdEvent->toArray());
