 ...
 */
class ExampleApplication_Setup_Update_16 extends Setup_Update_Abstract
{
    ...
    {
        $this->addApplicationUpdate('ExampleApplication', '16.0', self::RELEASE016_UPDATE000);
    }
    ...
    public function update001()
    {
        ...
        $this->addApplicationUpdate('ExampleApplication', '16.1', self::RELEASE016_UPDATE001);
    }
}
