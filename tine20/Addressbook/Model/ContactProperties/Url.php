...
/**
 * Contact Property Url Model
 *
 * @package     Addressbook
 * @subpackage  Model
 */
class Addressbook_Model_ContactProperties_Url extends Tinebase_Record_NewAbstract
    implements Addressbook_Model_ContactProperties_Interface, Tinebase_Record_JsonFacadeInterface
{
    ...
    public const MODEL_NAME_PART = 'ContactProperties_Url';
    //public const TABLE_NAME = 'addressbook_url';
