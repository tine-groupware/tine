 ...
 */
class OnlyOfficeIntegrator_Setup_Update_19 extends Setup_Update_Abstract
{
    ...
    {
        $this->addApplicationUpdate(OnlyOfficeIntegrator_Config::APP_NAME, '19.0', self::RELEASE019_UPDATE000);
    }
}
