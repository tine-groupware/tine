...
class UserManual_Setup_Initialize extends Setup_Initialize
{
    ...
    protected const USERMANUAL_STATE = 'usermanual_content_import';
    ...
    {
        $state = Tinebase_Application::getInstance()->getApplicationState('UserManual', self::USERMANUAL_STATE);
        if (! $overwrite && $state) {
        ...
        // TODO check (and maybe set) max_allowed_packet
