 ...
 */
class MatrixSynapseIntegrator_Setup_Update_20 extends Setup_Update_Abstract
{
    ...
    {
        $this->addApplicationUpdate(MatrixSynapseIntegrator_Config::APP_NAME, '20.0', self::RELEASE020_UPDATE000);
    }
}
