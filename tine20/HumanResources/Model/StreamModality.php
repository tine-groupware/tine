...
class HumanResources_Model_StreamModality extends Tinebase_Record_NewAbstract
{
    ...
    protected static $_modelConfiguration = [
        ...
        self::TITLE_PROPERTY        => "{# {{start - sorting! #}{{ start |localizeddate('short', 'none', app.user.locale ) }} - {% if end %}{{ end | localizeddate('short', 'none', app.user.locale ) }}{% else %}...{% endif %} {{ interval }} {{ num_interval }}× á {{ hours_interval }}h",
        self::DEFAULT_SORT_INFO     => [self::FIELD => self::FLD_START],
