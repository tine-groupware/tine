 ...
 */
/**
 * facade for BearerTokenValidator
 * copy of League\OAuth2\Server\AuthorizationValidators\BearerTokenValidator
 *
 * @package     SSO
 * @subpackage  Facade
...
class SSO_Facade_OAuth2_BearerTokenValidator implements AuthorizationValidatorInterface
{
    use CryptTrait;
