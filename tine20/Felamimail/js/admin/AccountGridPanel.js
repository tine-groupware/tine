    ...
    if (! Tine.Felamimail.admin.emailAccountsGridPanel) {
        Tine.Felamimail.admin.emailAccountsGridPanel = new Tine.Felamimail.AccountGridPanel({
            ...
            getCustomColumns: function() {
                return [{ header: this.app.i18n._('Email usage'), id: 'emailQuota', hidden: this.isEmailBackend, dataIndex: 'email_imap_user', renderer: Tine.Admin.user.GridPanel.prototype.emailQuotaRenderer, sortable: true}];
            },
