...
abstract class Felamimail_Sieve_Backend_Abstract
{
     ...
     *
     * @return Felamimail_Sieve_Forward|null
     */
    ...
    public function getSieve()
    {
        ...
        $header = (!empty($forwardings) || !empty($rules) || !empty($vacation) || !empty($scriptParts) ) ? $this->_getHeaderString() : '';
     ...
     * @return string
     */
    protected function _getForwardString()
    {
        if ($this->_forward) {
            $forward = $this->_forward->__toString();
        } else {
            $forward = '';
        }
     ...
     * set vacation
     *
     * @param Felamimail_Sieve_Forward $forward
     */
    public function setForward(Felamimail_Sieve_Forward $forward)
    {
    ...
    public function getDataFromScript(Felamimail_Sieve_Backend_Abstract $_scriptToCopyFrom)
    {
        ...
        $this->_forward = $_scriptToCopyFrom->getForward();
    }
}
