...
Tine.Calendar.AttendeeGridPanel = Ext.extend(Ext.grid.EditorGridPanel, {
            ...
            var items = [{
                ...
                handler: async function () {
                    ...
                    if (attender.get('user_type') == 'resource') {
                        ...
                        const attendeeName = await this.renderAttenderName(attender?.data?.user_id, {noIcon: true}, attender).asString();
    ...
    setDisabled: function(v) {
        if (v) {
            ...
            this.store.filterBy(function(r) {return ! (r.id && String(r.id).match(/^new-/))});
        } else {
