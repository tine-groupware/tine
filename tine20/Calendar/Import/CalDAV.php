...
class Calendar_Import_CalDAV extends Calendar_Import_Abstract
{
    ...
    public function import($_resource = NULL, $_clientRecordData = array())
    {
        ...
        if (!$this->_options[self::OPTION_FORCE_UPDATE_EXISTING]) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_EXTERNAL_SEQ_CHECK_BEFORE_UPDATE] = true;
        }
        if ($this->_options[self::OPTION_SKIP_INTERNAL_OTHER_ORGANIZER]) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_SKIP_INTERNAL_OTHER_ORGANIZER] = true;
        }
        if ($this->_options[self::OPTION_DISABLE_EXTERNAL_ORGANIZER_CALENDAR]) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_DISABLE_EXTERNAL_ORGANIZER_CALENDAR] = true;
        }
        ...
        if ($this->_options['keepExistingAttendee']) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_KEEP_EXISTING_ATTENDEE] = true;
        }
        if ($this->_options[self::OPTION_USE_OWN_ATTENDEE_FOR_SKIP_INTERNAL_OTHER_ORGANIZER_EVENTS]) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_USE_OWN_ATTENDEE_FOR_SKIP_INTERNAL_OTHER_ORGANIZER_EVENTS] = true;
        }
        if ($this->_options[self::OPTION_ALLOW_PARTY_CRUSH_FOR_SKIP_INTERNAL_OTHER_ORGANIZER_EVENTS]) {
            $caldavClientOptions[Calendar_Backend_CalDav_Client::OPT_ALLOW_PARTY_CRUSH_FOR_SKIP_INTERNAL_OTHER_ORGANIZER_EVENTS] = true;
        }
        ...
        if ($this->_options[self::OPTION_MATCH_ORGANIZER]) {
            $caldavClientOptions[self::OPTION_MATCH_ORGANIZER] = true;
        }
        if ($this->_options[self::OPTION_MATCH_ATTENDEES]) {
            $caldavClientOptions[self::OPTION_MATCH_ATTENDEES] = true;
        }
        ...
        $this->_calDAVClient = new Calendar_Backend_CalDav_Client($caldavClientOptions, 'Generic');
