        ...
        return [{
            ...
            items: [
                ...
                }, commonComboConfig), 
                {
                    ...
                    name: 'smtp_additionalexternaldomains',
                    fieldLabel: this.app.i18n._('Additional External Domains (comma separated)'),
                    xtype: 'textfield'
                }, {
                    name: 'smtp_allowAnyExternalDomains',
                    fieldLabel: this.app.i18n._('Allow any external domains'),
                    checked: false,
                    xtype: 'checkbox'
                },{
                    name: 'smtp_from',
