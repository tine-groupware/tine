            ...
            array(
                ...
                'updateAllAccountsWithAccountEmail' => 'create/update email users with current account
                 ...
                 'backup'                    => 'backup config and data
                           The config table is dumped separately; use configExcludeKeys to omit sensitive keys.
                          Examples:
                            setup.php --backup -- config=1 db=1 files=1 emailusers=1 backupDir=/backup/tine20 noTimestamp=1 novalidate=1 structTables=timemachine_modlog,notes configExcludeKeys=imap,smtp',
                ...
                'maintenance_mode'          => 'set systems maintenance mode state
                        Examples:
                           setup.php --maintenance_mode -- mode=[on|off] apps=[OnlyOfficeIntegrator,Felamimail,etc.] flags=[skipApps,onlyApps,allowAdminLogin,allowSsoPam]',
