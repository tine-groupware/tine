    ...
    tagsRenderer: function(tags) {
        ...
        if (tags) {
            for (var i = 0; i < tags.length; i += 1) {
                result += '<div style="float:left; margin:3px; font: 11px arial,tahoma,helvetica,sans-serif;"><div class="tb-grid-tags dark-reverse" style="background-color:' + tags[i].color + ';">&#160;</div> '+ Ext.util.Format.htmlEncode(tags[i].name) +'</div>';
            }
        }
        return result;
    },
