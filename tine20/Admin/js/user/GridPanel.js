...
Tine.Admin.user.GridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
    ...
    getColumns: function(){
        const columns = [
            ...
            { header: this.app.i18n._('Email usage'), id: 'emailQuota', dataIndex: 'emailUser', hidden: this.isEmailBackend, renderer: this.emailQuotaRenderer, sortable: true},
            { header: this.app.i18n._('Filesystem usage'), id: 'fileQuota', dataIndex: 'filesystemSize', renderer: this.fileQuotaRenderer, hidden: false, sortable: true},
