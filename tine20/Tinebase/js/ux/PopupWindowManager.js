...
//                if (Ext.isOpera) {
//                    Ext.Msg.alert(i18n._("The window you want to work with is in the background. Your browser doesn't support bringing the window to the foreground, so you need to use your operating system's window switching features. Please send complaints to your browser vendor!"))
//                }
                //orderWindows();
                return true;
            }
