...
abstract class Sales_Model_Document_Abstract extends Tinebase_Record_NewAbstract
{
    ...
    protected static $_modelConfiguration = [
        ...
        self::TITLE_PROPERTY                => '{{'. self::FLD_DOCUMENT_NUMBER . '}} {% if '. self::FLD_CUSTOMER_ID . '.id %}[{{ renderTitle('.self::FLD_CUSTOMER_ID.', "'.Sales_Model_Document_Customer::class.'") }}]{% endif %}{% if '. self::FLD_DOCUMENT_TITLE . '%} {{' . self::FLD_DOCUMENT_TITLE .'}}{% endif %}{% if '. self::FLD_DOCUMENT_DATE . '%} ({{'. self::FLD_DOCUMENT_DATE .'|localizeddate("short", "none", app.user.locale )}}){% endif %}',
