...
class Sales_Model_DocumentPosition_CustomerFilter extends Tinebase_Model_Filter_ForeignRecords
{
    /**
     * set options
     *
    ...
    {
        $value = [
            [TMFA::FIELD => Sales_Model_Document_Abstract::FLD_CUSTOMER_ID, TMFA::OPERATOR => 'definedBy?condition=and&setOperator=oneOf', TMFA::VALUE => [
