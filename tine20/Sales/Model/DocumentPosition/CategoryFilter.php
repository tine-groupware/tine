...
class Sales_Model_DocumentPosition_CategoryFilter extends Tinebase_Model_Filter_ForeignRecords
{
    /**
     * set options
     *
    ...
    {
        $value = [
            [TMFA::FIELD => Sales_Model_Document_Abstract::FLD_DOCUMENT_CATEGORY, TMFA::OPERATOR => 'definedBy?condition=and&setOperator=oneOf', TMFA::VALUE => $_value],
        ];
