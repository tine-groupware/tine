...
<!--ERP-->
Die Anwendung Inventarisierung gehört – wie Sales, HumanResources und Zeiterfassung – nicht zu den Kernfunktionalitäten einer Groupware. Diese Anwendungen sind als "ERP-Bausteine" im Laufe der Zeit auf Kundenwunsch entstanden und haben dann Eingang in {{ branding.title }} gefunden. Es werden sicher nicht die letzten Erweiterungen sein, sodass dieses Buch möglicherweise in der nächsten Auflage bereits weitere Zusatzanwendungen beschreiben wird.
