...
<!-- SCREENSHOT -->
![Abbildung: Eine Übersicht über alle tine-Anwendungen.]({{ img_url_desktop }}StandardBedienhinweise/1_standardbedienhinweise_alle_reiter_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Eine Übersicht über alle tine-Anwendungen.]({{ img_url_desktop }}StandardBedienhinweise/1_standardbedienhinweise_alle_reiter_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Eine Übersicht über alle tine-Anwendungen.]({{ img_url_mobile }}StandardBedienhinweise/1_standardbedienhinweise_alle_reiter_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Eine Übersicht über alle tine-Anwendungen.]({{ img_url_mobile }}StandardBedienhinweise/1_standardbedienhinweise_alle_reiter_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Die Liste mit den Filtern sieht in tine überall gleich aus. Hier exemplarisch die Anwendung Kalender.]({{ img_url_desktop }}StandardBedienhinweise/2_standardbedienhinweise_kalender_filterliste_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Die Liste mit den Filtern sieht in tine überall gleich aus. Hier exemplarisch die Anwendung Kalender.]({{ img_url_desktop }}StandardBedienhinweise/2_standardbedienhinweise_kalender_filterliste_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Die Liste mit den Filtern sieht in tine überall gleich aus. Hier exemplarisch die Anwendung Kalender.]({{ img_url_mobile }}StandardBedienhinweise/2_standardbedienhinweise_kalender_filterliste_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Die Liste mit den Filtern sieht in tine überall gleich aus. Hier exemplarisch die Anwendung Kalender.]({{ img_url_mobile }}StandardBedienhinweise/2_standardbedienhinweise_kalender_filterliste_dark_1280x720.png#only-dark){.mobile-img}
...
In allen Anwendungen, außer dem Kalender, enthält er ein Eingabefeld Seite x von n, in das Sie eine Seitenzahl händisch eingeben können, sowie auf jeder Seite jeweils zwei Pfeiltasten für die Funktionen "Seite hoch" <img src="{{icon_url}}icon_arrow_right.svg" alt="drawing" width="16"/>, "Seite runter" <img src="{{icon_url}}icon_arrow_left.svg" alt="drawing" width="16"/>, "Anfang" <img src="{{icon_url}}icon_arrow_back_last.svg" alt="drawing" width="16"/> und "Ende" <img src="{{icon_url}}icon_arrow_action_last.svg" alt="drawing" width="16"/>. Im Kalender ist die Ansicht dieses Eingabefeldes abhängig von der Kalenderansicht (Tag, Woche oder Monat). Bei der Tages- und Monatsansicht ist es ein Pulldown mit anklickbaren Tagen oder Monaten, bei der Wochenansicht ist es ein Eingabefeld Woche. Als Pfeiltasten gibt es im Kalender nur "vor" und "zurück".
...
Nachdem wir uns mit allen Bedienelementen oberhalb der Tabelle beschäftigt haben, kommen wir nun zum Favoriten- und Ordnerbaum, den Sie links von der Tabelle finden. Bereits in der tine-Standardinstallation ist in jeder Anwendung eine Reihe von vordefinierten Favoriten enthalten, die sich für die tägliche Arbeit als nützlich erwiesen haben. Zu den speziellen Einstellungen für Favoriten kommen wir weiter unten im [Favoriten definieren](ca_StandardBedienhinweise.md/#favoriten-definieren), weil wir Ihnen zuvor noch das Setzen von Filtern beschreiben möchten, die Sie dann als Favoriten speichern können.
...
<!-- SCREENSHOT -->
![Abbildung: Aufrufen der Berechtigungsverwaltung eines Adressbuches im Kontextmenü]({{ img_url_desktop }}StandardBedienhinweise/3_standardbedienhinweise_adresse_berechtigungen_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Aufrufen der Berechtigungsverwaltung eines Adressbuches im Kontextmenü]({{ img_url_desktop }}StandardBedienhinweise/3_standardbedienhinweise_adresse_berechtigungen_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Aufrufen der Berechtigungsverwaltung eines Adressbuches im Kontextmenü]({{ img_url_mobile }}StandardBedienhinweise/3_standardbedienhinweise_adresse_berechtigungen_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Aufrufen der Berechtigungsverwaltung eines Adressbuches im Kontextmenü]({{ img_url_mobile }}StandardBedienhinweise/3_standardbedienhinweise_adresse_berechtigungen_dark_1280x720.png#only-dark){.mobile-img}

Das daraufhin erscheinende Fenster zur Berechtigungsverwaltung sieht wie folgt aus:

<!-- SCREENSHOT -->
![Abbildung: Die Berechtigungsverwaltung eines Adressbuches]({{ img_url_desktop }}StandardBedienhinweise/4_standardbedienhinweise_adressbuch_berechtigungen_verwalten_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Die Berechtigungsverwaltung eines Adressbuches]({{ img_url_desktop }}StandardBedienhinweise/4_standardbedienhinweise_adressbuch_berechtigungen_verwalten_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Die Berechtigungsverwaltung eines Adressbuches]({{ img_url_mobile }}StandardBedienhinweise/4_standardbedienhinweise_adressbuch_berechtigungen_verwalten_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Die Berechtigungsverwaltung eines Adressbuches]({{ img_url_mobile }}StandardBedienhinweise/4_standardbedienhinweise_adressbuch_berechtigungen_verwalten_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: tine-Tabelle am Beispiel der E-Mail-Anwendung]({{ img_url_desktop }}StandardBedienhinweise/5_standardbedienhinweise_email_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: tine-Tabelle am Beispiel der E-Mail-Anwendung]({{ img_url_desktop }}StandardBedienhinweise/5_standardbedienhinweise_email_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: tine-Tabelle am Beispiel der E-Mail-Anwendung]({{ img_url_mobile }}StandardBedienhinweise/5_standardbedienhinweise_email_light_1280x720.png#only-light){.mobile-img}
![Abbildung: tine-Tabelle am Beispiel der E-Mail-Anwendung]({{ img_url_mobile }}StandardBedienhinweise/5_standardbedienhinweise_email_dark_1280x720.png#only-dark){.mobile-img}
...
<!--Tabellenkopfsymbol-->
Am rechten äußeren Rand des Tabellenkopfes finden Sie immer einen kleinen Button (<img src="{{icon_url}}icon_column.svg" alt="drawing" width="16"/>), den wir hier durchgehend "Tabellenkopfsymbol" nennen. Dieser Button begegnet Ihnen nicht nur am rechten Rand der großen Tabelle in der Hauptansicht einer Anwendung, sondern auch in Arbeitsfenstern, wenn Sie Tabellen aufweisen. Seine Funktion ist immer gleich: Nach dem Anklicken gibt er eine Liste mit Checkbuttons frei, die es Ihnen erlauben, Tabellenspalten ein- oder auszublenden:

<!-- SCREENSHOT -->
![Abbildung: Alle anzeigbaren Spalten der E-Mail-Anwendung]({{ img_url_desktop }}StandardBedienhinweise/6_standardbedienhinweise_email_spaltenauswahl_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Alle anzeigbaren Spalten der E-Mail-Anwendung]({{ img_url_desktop }}StandardBedienhinweise/6_standardbedienhinweise_email_spaltenauswahl_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Alle anzeigbaren Spalten der E-Mail-Anwendung]({{ img_url_mobile }}StandardBedienhinweise/6_standardbedienhinweise_email_spaltenauswahl_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Alle anzeigbaren Spalten der E-Mail-Anwendung]({{ img_url_mobile }}StandardBedienhinweise/6_standardbedienhinweise_email_spaltenauswahl_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Auswahl der möglichen Elemente, nach denen in einer Ansicht gefiltert werden kann]({{ img_url_desktop }}StandardBedienhinweise/7_standardbedienhinweise_email_suchoptionen_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Auswahl der möglichen Elemente, nach denen in einer Ansicht gefiltert werden kann]({{ img_url_desktop }}StandardBedienhinweise/7_standardbedienhinweise_email_suchoptionen_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Auswahl der möglichen Elemente, nach denen in einer Ansicht gefiltert werden kann]({{ img_url_mobile }}StandardBedienhinweise/7_standardbedienhinweise_email_suchoptionen_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Auswahl der möglichen Elemente, nach denen in einer Ansicht gefiltert werden kann]({{ img_url_mobile }}StandardBedienhinweise/7_standardbedienhinweise_email_suchoptionen_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Das Suchfenster auf der rechten Seite über der Tabelle]({{ img_url_desktop }}StandardBedienhinweise/8_standardbedienhinweise_suchfilter_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Das Suchfenster auf der rechten Seite über der Tabelle]({{ img_url_desktop }}StandardBedienhinweise/8_standardbedienhinweise_suchfilter_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Das Suchfenster auf der rechten Seite über der Tabelle]({{ img_url_mobile }}StandardBedienhinweise/8_standardbedienhinweise_suchfilter_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Das Suchfenster auf der rechten Seite über der Tabelle]({{ img_url_mobile }}StandardBedienhinweise/8_standardbedienhinweise_suchfilter_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Der x-Button zum Löschen einer Such-Zeichenkette]({{ img_url_desktop }}StandardBedienhinweise/9_standardbedienhinweise_suchfilter_x_button_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Der x-Button zum Löschen einer Such-Zeichenkette]({{ img_url_desktop }}StandardBedienhinweise/9_standardbedienhinweise_suchfilter_x_button_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Der x-Button zum Löschen einer Such-Zeichenkette]({{ img_url_mobile }}StandardBedienhinweise/9_standardbedienhinweise_suchfilter_x_button_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Der x-Button zum Löschen einer Such-Zeichenkette]({{ img_url_mobile }}StandardBedienhinweise/9_standardbedienhinweise_suchfilter_x_button_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Zurücksetzen aller angelegten Filter in einem Arbeitsgang.]({{ img_url_desktop }}StandardBedienhinweise/110_standardbedienhinweise_alle_filter_zuruecksetzen_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Zurücksetzen aller angelegten Filter in einem Arbeitsgang.]({{ img_url_desktop }}StandardBedienhinweise/110_standardbedienhinweise_alle_filter_zuruecksetzen_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Zurücksetzen aller angelegten Filter in einem Arbeitsgang.]({{ img_url_mobile }}StandardBedienhinweise/110_standardbedienhinweise_alle_filter_zuruecksetzen_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Zurücksetzen aller angelegten Filter in einem Arbeitsgang.]({{ img_url_mobile }}StandardBedienhinweise/110_standardbedienhinweise_alle_filter_zuruecksetzen_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Operator-Elemente, nach denen gefiltert werden kann.]({{ img_url_desktop }}StandardBedienhinweise/11_standardbedienhinweise_email_suchfilter_operatoren_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Operator-Elemente, nach denen gefiltert werden kann.]({{ img_url_desktop }}StandardBedienhinweise/11_standardbedienhinweise_email_suchfilter_operatoren_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Operator-Elemente, nach denen gefiltert werden kann.]({{ img_url_mobile }}StandardBedienhinweise/11_standardbedienhinweise_email_suchfilter_operatoren_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Operator-Elemente, nach denen gefiltert werden kann.]({{ img_url_mobile }}StandardBedienhinweise/11_standardbedienhinweise_email_suchfilter_operatoren_dark_1280x720.png#only-dark){.mobile-img}
...
In der praktischen Tätigkeit werden Ihnen jedoch auch Anwendungsfälle begegnen, in denen die Frage nicht und (also "sowohl als auch"), sondern "oder" lautet. D.h. Sie haben zwei oder mehr Suchkriterien, die gemeinsam, aber auch nur jeweils einzeln auf Datensätze zutreffen können, nach denen Sie suchen. Auch das ist möglich: Klappen Sie sich dazu das Menü ODER ALTERNATIV[^1] am rechten Rand heraus, indem Sie auf das kleine Dreieck oder den Text klicken:

[^1]:
    In den Anwendungen Admin und Dateimanager gibt es diese Option nicht!

<!-- SCREENSHOT -->
![Abbildung: Alternative "Oder"-Filter-Möglichkeiten]({{ img_url_desktop }}StandardBedienhinweise/12_standardbedienhinweise_alternative_oder_filter_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Alternative "Oder"-Filter-Möglichkeiten]({{ img_url_desktop }}StandardBedienhinweise/12_standardbedienhinweise_alternative_oder_filter_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Alternative "Oder"-Filter-Möglichkeiten]({{ img_url_mobile }}StandardBedienhinweise/12_standardbedienhinweise_alternative_oder_filter_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Alternative "Oder"-Filter-Möglichkeiten]({{ img_url_mobile }}StandardBedienhinweise/12_standardbedienhinweise_alternative_oder_filter_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Weitere "Oder"-Filter hinzufügen]({{ img_url_desktop }}StandardBedienhinweise/13_standardbedienhinweise_weitere_alternative_filter_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Weitere "Oder"-Filter hinzufügen]({{ img_url_desktop }}StandardBedienhinweise/13_standardbedienhinweise_weitere_alternative_filter_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Weitere "Oder"-Filter hinzufügen]({{ img_url_mobile }}StandardBedienhinweise/13_standardbedienhinweise_weitere_alternative_filter_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Weitere "Oder"-Filter hinzufügen]({{ img_url_mobile }}StandardBedienhinweise/13_standardbedienhinweise_weitere_alternative_filter_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Dauerhaftes Entfernen eines kompletten "Oder"-Filters]({{ img_url_desktop }}StandardBedienhinweise/14_standardbedienhinweise_alternativen_filter_entfernen_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Dauerhaftes Entfernen eines kompletten "Oder"-Filters]({{ img_url_desktop }}StandardBedienhinweise/14_standardbedienhinweise_alternativen_filter_entfernen_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Dauerhaftes Entfernen eines kompletten "Oder"-Filters]({{ img_url_mobile }}StandardBedienhinweise/14_standardbedienhinweise_alternativen_filter_entfernen_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Dauerhaftes Entfernen eines kompletten "Oder"-Filters]({{ img_url_mobile }}StandardBedienhinweise/14_standardbedienhinweise_alternativen_filter_entfernen_dark_1280x720.png#only-dark){.mobile-img}

Sie können einen alternativen Filter(-strang) auch zeitweise deaktivieren, indem Sie den Checkbutton abklicken:

<!--
Screenshot E-Mail-Client, roter Checkbutton abgeklickt
-->
...
<!--Favoriten-Ansicht-->
Hier noch eine ganz wesentliche Funktion: Nachdem Sie sich, vielleicht durch längeres Probieren, einen Filter über mehrere Stränge erstellt haben, den Sie nun zukünftig öfter verwenden wollen, wünschen Sie sich wahrscheinlich, diesen dauerhaft zur Verfügung zu haben. In diesen Fall klicken sie auf das Disketten-Symbol (<img src="{{icon_url}}icon_safe_neg.svg" alt="drawing" width="16"/>), welches sich bei den Filterfunktionen versteckt. Klicken Sie ihn an, und Sie erhalten das folgende Fenster:

<!-- SCREENSHOT -->
![Abbildung: Häufig benutzte oder komplexe Filter können als Favorit gespeichert werden.]({{ img_url_desktop }}StandardBedienhinweise/15_standardbedienhinweise_email_filter_favoriten_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Häufig benutzte oder komplexe Filter können als Favorit gespeichert werden.]({{ img_url_desktop }}StandardBedienhinweise/15_standardbedienhinweise_email_filter_favoriten_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Häufig benutzte oder komplexe Filter können als Favorit gespeichert werden.]({{ img_url_mobile }}StandardBedienhinweise/15_standardbedienhinweise_email_filter_favoriten_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Häufig benutzte oder komplexe Filter können als Favorit gespeichert werden.]({{ img_url_mobile }}StandardBedienhinweise/15_standardbedienhinweise_email_filter_favoriten_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT Abbildung 2.16 -->
![Abbildung: Eine typische Eingabemaske in tine am Beispiel "Neuen Mitarbeiter hinzufügen"]({{ img_url }})
...
<!--Notizen-->
Wie wir schon in [Adressverwaltung - Kontakte in der Kontaktmaske bearbeiten](ba_Adressbuch.md/#kontakte-in-der-kontaktmaske-bearbeiten) gesehen haben, kennt tine drei Arten von Notizen: einfache Notizen, Telefonnotizen und E-Mail-Notizen. In dem Reiter Notizen finden sie eine Übersicht aller, für die jeweilige Anwendung spezifischen, Notizen.

<!-- SCREENSHOT -->
![Abbildung: Übersicht- Reiter "Notizen"]({{ img_url_desktop }}StandardBedienhinweise/17_standardbedienhinweise_hr_eingabemaske_neu_notiz_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Übersicht- Reiter "Notizen"]({{ img_url_desktop }}StandardBedienhinweise/17_standardbedienhinweise_hr_eingabemaske_neu_notiz_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Übersicht- Reiter "Notizen"]({{ img_url_mobile }}StandardBedienhinweise/17_standardbedienhinweise_hr_eingabemaske_neu_notiz_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Übersicht- Reiter "Notizen"]({{ img_url_mobile }}StandardBedienhinweise/17_standardbedienhinweise_hr_eingabemaske_neu_notiz_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Verschiedene Arten von Notizen, die hinzugefügt werden können]({{ img_url_desktop }}StandardBedienhinweise/18_standardbedienhinweise_hr_eingabemaske_neu_notiz_notiz_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Verschiedene Arten von Notizen, die hinzugefügt werden können]({{ img_url_desktop }}StandardBedienhinweise/18_standardbedienhinweise_hr_eingabemaske_neu_notiz_notiz_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Verschiedene Arten von Notizen, die hinzugefügt werden können]({{ img_url_mobile }}StandardBedienhinweise/18_standardbedienhinweise_hr_eingabemaske_neu_notiz_notiz_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Verschiedene Arten von Notizen, die hinzugefügt werden können]({{ img_url_mobile }}StandardBedienhinweise/18_standardbedienhinweise_hr_eingabemaske_neu_notiz_notiz_dark_1280x720.png#only-dark){.mobile-img}

Alle Notizen erhalten mit Speicherung automatisch einen Datums- und Zeiteintrag.

<!--Notizen,E-Mail-Notizen-->
Als zunächst etwas verwirrend erscheint Ihnen vielleicht der Tatbestand, dass beim Anwählen der anderen beiden Funktionen, Telefon Notiz und E-Mail Notiz, augenscheinlich nichts anderes passiert: Das angebotene Eingabefenster heißt ebenfalls Notiz hinzufügen und enthält genau so nur die Möglichkeit, einfachen Text einzugeben. Jedoch werden diese beiden Arten von Notizen bei der Auflistung im rechten Teil der Eingabemaske mit den speziellen Piktogrammen für E-Mail- und Telefonnotizen gekennzeichnet, sodass Sie und andere Anwender auf den ersten Blick sehen, um welche Art von Notizen es sich handelt. Dabei werden Sie eine Telefonnotiz dann verwenden, wenn Sie mit jemandem zum betreffenden Datenbankobjekt ein Telefonat geführt haben oder es sich direkt um einen Kontaktdatensatz handelt. Desgleichen bei E-Mail-Notizen, wobei hier noch eine automatische Funktion eingebaut ist: Wenn Sie in Ihren individuellen Einstellungen (oben rechts Benutzer: ....\[E-Mail, E-Mail-Notiz erzeugen, ja\], beschrieben in [Benutzerspezifische Einstellungen - E-Mail](na_Benutzereinstellungen.md/#e-mail)) ausgewählt haben, dass bei jeder E-Mail an einen gespeicherten Kontakt eine Notiz angelegt werden soll, dann erzeugt tine für Sie jeweils eine E-Mail-Notiz mit dem Inhalt der E-Mail als Anhang an den Kontaktdatensatz.
...
<!-- SCREENSHOT -->
![Abbildung: Einem Objekt können beliebige Dateien als Anhänge zugewiesen werden.]({{ img_url_desktop }}2_allgemeines/22_allgemein_hr_mitarbeiter_anhang_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Einem Objekt können beliebige Dateien als Anhänge zugewiesen werden.]({{ img_url_desktop }}2_allgemeines/22_allgemein_hr_mitarbeiter_anhang_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Einem Objekt können beliebige Dateien als Anhänge zugewiesen werden.]({{ img_url_mobile }}2_allgemeines/22_allgemein_hr_mitarbeiter_anhang_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Einem Objekt können beliebige Dateien als Anhänge zugewiesen werden.]({{ img_url_mobile }}2_allgemeines/22_allgemein_hr_mitarbeiter_anhang_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT -->
![Abbildung: Mit einem Objekt verknüpfte Objekte anderer tine-Anwendungen]({{ img_url_desktop }}2_allgemeines/23_allgemein_hr_mitarbeiter_verknuepfungen_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Mit einem Objekt verknüpfte Objekte anderer tine-Anwendungen]({{ img_url_desktop }}2_allgemeines/23_allgemein_hr_mitarbeiter_verknuepfungen_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Mit einem Objekt verknüpfte Objekte anderer tine-Anwendungen]({{ img_url_mobile }}2_allgemeines/23_allgemein_hr_mitarbeiter_verknuepfungen_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Mit einem Objekt verknüpfte Objekte anderer tine-Anwendungen]({{ img_url_mobile }}2_allgemeines/23_allgemein_hr_mitarbeiter_verknuepfungen_dark_1280x720.png#only-dark){.mobile-img}
...
<!-- SCREENSHOT Abbildung 2.21 -->
![Abbildung: Die Auswahl der Objektgruppe einer tine-Anwendung zum Verknüpfen]({{ img_url }})
...
<!-- SCREENSHOT -->
![Abbildung: Die Bearbeitungs-Historie eines Datenbankobjektes]({{ img_url_desktop }}2_allgemeines/21_allgemein_hr_mitarbeiter_historie_light_1920x1020.png#only-light){.desktop-img}
![Abbildung: Die Bearbeitungs-Historie eines Datenbankobjektes]({{ img_url_desktop }}2_allgemeines/21_allgemein_hr_mitarbeiter_historie_dark_1920x1020.png#only-dark){.desktop-img}
![Abbildung: Die Bearbeitungs-Historie eines Datenbankobjektes]({{ img_url_mobile }}2_allgemeines/21_allgemein_hr_mitarbeiter_historie_light_1280x720.png#only-light){.mobile-img}
![Abbildung: Die Bearbeitungs-Historie eines Datenbankobjektes]({{ img_url_mobile }}2_allgemeines/21_allgemein_hr_mitarbeiter_historie_dark_1280x720.png#only-dark){.mobile-img}
...
<!--Tags-->
Kommen wir nun zu den Tags. tine unterscheidet zwischen persönlichen und systemübergreifend gültigen, sogenannten gemeinsamen Tags. Wie Sie letztere vergeben, besprechen wir in [Administration - Gemeinsame Tags](oa_Administration.md/#gemeinsame-tags). Persönliche Tags hingegen können Sie in jeder Objekt-Bearbeitungsmaske, unten rechts mit dem kleinen Pluszeichen, neben dem Pulldown Tag Name, anlegen:

<!-- SCREENSHOT Abbildung 2.23 -->
![Abbildung: Das Eingabefeld für einen persönlichen Tag]({{ img_url }})
...
<!-- SCREENSHOT Abbildung 2.24 -->
![Abbildung: Die Auswahl bestehender Tags]({{ img_url }})