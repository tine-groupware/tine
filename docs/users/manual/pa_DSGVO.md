...
In der Applikation Stammdaten finden Sie nun das Modul DSGVO mit den beiden Unterpunkten Datenherkünfte und Verwendungszwecke. Hier können Sie neue Datenherkünfte und Verwendungszwecke für Ihre Daten anlegen. Per Default steht ihnen sonst die Herkunft {{ branding.title }} zur Verfügung.
