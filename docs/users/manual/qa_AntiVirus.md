...
Um den Antivirus-Service zu nutzen, muss ClamAV (hierbei handelt es sich um einen Standard-Open-Source-Virenscanner) in {{ branding.title }} konfiguriert werden.

Sofern das geschehen ist, werden alle Dateien (ausgenommen E-Mail-Anhänge) die in {{ branding.title }} zur Verfügung stehen, wöchentlich auf Viren, Trojaner, Malware und andere Gefahren geprüft. Sollte der Scan positiv sein, wird diese Datei entsprechend markiert.
